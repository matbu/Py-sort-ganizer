...
help to organized everything in a destination directory.
    ...
    usage: sort.py [-h] -o ORIGIN -d DESTINATION [-dp DEPTH] [-e {image/jpeg,video/mp4,audio/mpeg,image/gif,image}] [-nt]
    ...
    options:
      ...
      -dp DEPTH, --depth DEPTH
                            Depth of the tree, 0 is no tree, 1 is year level, 2 is year/month, 3 is year/month/day (default)
    ...
    python3 sort.py -o Documents -d /tmp/testsorted -e image/jpeg --depth 2
